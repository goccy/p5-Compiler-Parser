...
TokenInfo decl_tokens[] = {
	...
	{Enum::Token::Type::Package, Enum::Token::Kind::Stmt, "Package", "package"},
	{Enum::Token::Type::Class, Enum::Token::Kind::Stmt, "Class", ""},
	...
	{Enum::Token::Type::RegOpt, Enum::Token::Kind::Term, "RegOpt", ""},
	{Enum::Token::Type::RegQuote, Enum::Token::Kind::Term, "RegQuote", "q"},
	{Enum::Token::Type::RegDoubleQuote, Enum::Token::Kind::Term, "RegDoubleQuote", "qq"},
	{Enum::Token::Type::RegList, Enum::Token::Kind::Term, "RegList", "qw"},
	{Enum::Token::Type::RegExec, Enum::Token::Kind::Term, "RegExec", "qx"},
	{Enum::Token::Type::RegDecl, Enum::Token::Kind::Term, "RegDecl", "qr"},
	{Enum::Token::Type::RegMatch, Enum::Token::Kind::Term, "RegMatch", "m"},
	{Enum::Token::Type::RegDelim, Enum::Token::Kind::Term, "RegDelim", ""},
	{Enum::Token::Type::RegMiddleDelim, Enum::Token::Kind::Term, "RegMiddleDelim", ""},
	{Enum::Token::Type::RegAllReplace, Enum::Token::Kind::Term, "RegAllReplace", "tr"},
	{Enum::Token::Type::RegAllReplace, Enum::Token::Kind::Term, "RegAllReplace", "y"},
	{Enum::Token::Type::RegReplace, Enum::Token::Kind::Term, "RegReplace", "s"},
