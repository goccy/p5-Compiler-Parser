...
subtest 'Plack::Component' => sub {
    ...
    is(ref $ast->root->next->next->next, 'Compiler::Parser::Node::Module');
    is(ref $ast->root->next->next->next->args, 'Compiler::Parser::Node::List');
    ...
    is(ref $ast->root->next->next->next->next->next->args, 'Compiler::Parser::Node::Branch');
    is(ref $ast->root->next->next->next->next->next->args->left, 'Compiler::Parser::Node::Branch');
    is(ref $ast->root->next->next->next->next->next->args->left->left, 'Compiler::Parser::Node::Leaf');
    is(ref $ast->root->next->next->next->next->next->args->left->right, 'Compiler::Parser::Node::Function');
    is(ref $ast->root->next->next->next->next->next->args->left->right->body, 'Compiler::Parser::Node::Branch');
    is(ref $ast->root->next->next->next->next->next->args->left->right->body->left, 'Compiler::Parser::Node::FunctionCall');
    is(ref $ast->root->next->next->next->next->next->args->left->right->body->right, 'Compiler::Parser::Node::FunctionCall');
    is(ref $ast->root->next->next->next->next->next->args->left->right->body->right->{args}[0], 'Compiler::Parser::Node::Leaf');
    is(ref $ast->root->next->next->next->next->next->args->right, 'Compiler::Parser::Node::Branch');
    is(ref $ast->root->next->next->next->next->next->args->right->left, 'Compiler::Parser::Node::Leaf');
    is(ref $ast->root->next->next->next->next->next->args->right->right, 'Compiler::Parser::Node::Leaf');

    my $new = $ast->root->next->next->next->next->next->next;
